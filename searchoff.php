...
$sql = "SELECT Registration_no,Patient_Name,Age,Contact,Department,Doctor_Name,DATE FROM offline_booking where DATE='$id'";
...
echo "</table><br><br><br><br><br></br>";
   ...
   $sql = "SELECT Registration_no FROM offline_booking where DATE='$id'";
