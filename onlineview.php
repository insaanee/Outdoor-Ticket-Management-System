...
<h1><b>View Offlline Bokking</b></h1>
   ...
   <?php
	...
	//echo "Connected successfully\n";
		...
		$sql = "SELECT * FROM Online_booking";
			...
			while ($row = $result->fetch_assoc()) {
				...
				if(isset($_GET[$row['Registration_no']])){
					...
					if(isset($_POST['submit'])){
						...
						$ssql = "UPDATE Online_booking SET Registration_no='$Registration_no',Patient_Name='$Patient_Name', Age='$Age', Contact='$Contact', Department='$Department', Doctor_Name='$Doctor_Name', DATE='$DATE'
				...
				if(isset($_GET['delete'.$row['Registration_no']])){
					$delete = "DELETE FROM Online_booking WHERE Registration_no=".$row['Registration_no']."";
   ...
   $sql = "SELECT Registration_no FROM online_booking";
